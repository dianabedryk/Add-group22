...
def test_add_contact(app):
    ...
    app.group_contact.fill_add_address_book_entry(Contact(firstname="dfg", middlename="kmn", lastname="yhj", nickname="rgi",
...
def test_add_empty_contact(app):
        app.session_contact.login(username="admin", password="secret")
        app.group_contact.fill_add_address_book_entry(Contact(firstname="", middlename="", lastname="", nickname="", title="",
